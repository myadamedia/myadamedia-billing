...
# Tarik pembaruan dari Git (GitHub)
echo -e "${BLUE}[INFO]${NC} Mengambil kode terbaru dari GitHub..."
if git pull; then
  echo -e "${GREEN}[OK]${NC} Kode berhasil diperbarui dari repositori."
else
  echo -e "${YELLOW}[WARN]${NC} Gagal melakukan 'git pull'. Melanjutkan proses update lokal..."
fi
